...
from lib.models.common import Conv, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3K2, Focus, Concat, Detect, SharpenConv
...
[ -1, Focus, [3, 32, 3]],   #0
[ -1, Conv, [32, 64, 3, 2]],    #1
[ -1, C3K2, [64, 64, 1, True]],  #2  # n=1, shortcut=True
[ -1, Conv, [64, 128, 3, 2]],   #3
[ -1, C3K2, [128, 128, 2, True]],    #4  # n=3->2, shortcut=True
[ -1, Conv, [128, 256, 3, 2]],  #5
[ -1, C3K2, [256, 256, 3, True]],    #6  # n=3, shortcut=True
[ -1, Conv, [256, 512, 3, 2]],  #7
[ -1, SPPF, [512, 512, 5]],     #8
[ -1, C2f, [512, 512, 1, True]],     #9  # shortcut=False->True
[ -1, Conv,[512, 256, 1, 1]],   #10
[ -1, Upsample, [None, 2, 'nearest']],  #11
[ [-1, 6], Concat, [1]],    #12
[ -1, C2f, [512, 256, 2, True]], #13  # n=1->2, shortcut=True
[ -1, Conv, [256, 128, 1, 1]],  #14
[ -1, Upsample, [None, 2, 'nearest']],  #15
[ [-1,4], Concat, [1]],     #16         #Encoder

[ -1, C2f, [256, 128, 2, True]],     #17  # n=1->2, shortcut=True
[ -1, Conv, [128, 128, 3, 2]],      #18
[ [-1, 14], Concat, [1]],       #19
[ -1, C2f, [256, 256, 2, True]],     #20  # n=1->2, shortcut=True
[ -1, Conv, [256, 256, 3, 2]],      #21
[ [-1, 10], Concat, [1]],   #22
[ -1, C2f, [512, 512, 2, True]],     #23  # n=1->2, shortcut=True
[ [17, 20, 23], Detect,  [1, [[3,9,5,11,4,20], [7,18,6,39,12,31], [19,50,38,81,68,157]], [128, 256, 512]]], #Detection head 24

[ 16, Conv, [256, 128, 3, 1]],   #25
[ -1, Upsample, [None, 2, 'nearest']],  #26
[ -1, C2f, [128, 64, 1, False]],  #27
[ -1, Conv, [64, 32, 3, 1]],    #28
[ -1, Upsample, [None, 2, 'nearest']],  #29
[ -1, Conv, [32, 16, 3, 1]],    #30
[ -1, C2f, [16, 8, 1, False]],    #31
[ -1, Upsample, [None, 2, 'nearest']],  #32
[ -1, Conv, [8, 2, 3, 1]], #33 Driving area segmentation head

[ 16, Conv, [256, 128, 3, 1]],   #34
[ -1, Upsample, [None, 2, 'nearest']],  #35
[ -1, C2f, [128, 64, 1, False]],  #36
[ -1, Conv, [64, 32, 3, 1]],    #37
[ -1, Upsample, [None, 2, 'nearest']],  #38
[ -1, Conv, [32, 16, 3, 1]],    #39
[ -1, C2f, [16, 8, 1, False]],    #40
